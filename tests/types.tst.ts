...
describe('Basic Procedure Type Inference', () => {
	test('should infer a plain procedure', () => {
		...
		expect(procedure).type.toBe<Procedure<Context, undefined, undefined, undefined>>()
	...
	test('should infer a procedure with params', () => {
		...
		expect(procedure).type.toBe<Procedure<Context, TObject<{ id: TString }>, undefined, undefined>>()
	...
	test('should infer a procedure with query', () => {
		...
		expect(procedure).type.toBe<Procedure<Context, undefined, TObject<{ page: TNumber }>, undefined>>()
		expect(procedure.params).type.toBeUndefined()
	...
	test('should infer a procedure with body', () => {
		...
		expect(procedure).type.toBe<Procedure<Context, undefined, undefined, TObject<{ data: TString }>>>()
		expect(procedure.params).type.toBeUndefined()
		expect(procedure.query).type.toBeUndefined()
	...
	test('should infer a procedure with all schemas', () => {
		...
		expect(procedure).type.toBe<Procedure<Context, TObject<{ id: TString }>, TObject<{ page: TNumber }>, TObject<{ data: TString }>>>()
		expect(procedure.params).type.toBe<TObject<{ id: TString }>>()
		expect(procedure.query).type.toBe<TObject<{ page: TNumber }>>()
		expect(procedure.body).type.toBe<TObject<{ data: TString }>>()
	})
	...
	test('should infer a procedure with chained params', () => {
		...
		expect(procedure).type.toBe<Procedure<Context, TObject<{ id: TString, name: TString }>, undefined, undefined>>()
	...
	test('should handle complex objects in body', () => {
		...
		expect(procedure).type.toBe<Procedure<Context, undefined, undefined, TObject<{ data: TObject<{ id: TString, name: TString, count: TNumber }> }>>>()
		expect(procedure.params).type.toBeUndefined()
		expect(procedure.query).type.toBeUndefined()
...
describe('Chained Procedure Type Inference', () => {
	...
	test('should not allow overriding base procedure input', () => {
		...
		expect(derivedProcedure).type.toBe<Procedure<Context, never, undefined, undefined>>()
...
describe('Action Inference', () => {
	test('should infer a plain action', () => {
		...
		expect(action).type.toBe<Action<Context, undefined, undefined, undefined, undefined, void>>()
	...
	test('should not allow overriding a procedure input', () => {
		...
		expect(action).type.toBe<Action<Context, never, undefined, undefined, undefined, void>>()
	...
	test('should infer the action return type with handle', async () => {
		...
		expect(action).type.toBe<Action<Context, undefined, undefined, undefined, undefined, { processed: boolean }>>()
